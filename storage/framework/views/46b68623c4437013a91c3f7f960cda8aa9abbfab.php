        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <input name="harga" value="<?php echo e(old('jumlah_jam')); ?>" id="jumlah_jam" placeholder="Jumlah Jumlah" class="form-control">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 7\SKRIPSI\PEMROGRAMAN\photography (1)\photography\resources\views/dashboard/paket/create.blade.php ENDPATH**/ ?>