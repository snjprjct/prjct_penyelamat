    ...
    <div class="form-content">
      <form method="post" action="/login">
        ...
        <div class="form-group">
          ...
          <input type="text" id="username" name="username" required="required" value="<?php echo e(old('username')); ?> "/>
        </div>
        <div class="form-group">
...
</script><?php /**PATH D:\laravel\coba1\spp\resources\views/login/index.blade.php ENDPATH**/ ?>