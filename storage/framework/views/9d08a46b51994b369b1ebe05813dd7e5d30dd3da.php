 ...
 <!--? Gallery Area Start -->
    <div class="gallery-area section-padding40">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-12">
                <img src="<?php echo e(asset('rettro-main/assets/img/gallery/instra7.jpg')); ?>" alt="image" height="400" width="inherit">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="box snake mb-30">
                        ...
                        <div class="overlay">
                            <div class="overlay-content">
                                <a href="<?php echo e(asset('storage/' . $galery->foto)); ?>" class="img-pop-up"><i class="ti-zoom-in"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- <div class="all-starups-area fix"> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                <img src="<?php echo e(asset('rettro-main/assets/img/gallery/instra6.jpg')); ?>" alt="image" height="inherit" width="1170">
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Zahlan Nugraha\Downloads\photography\photography\resources\views/home.blade.php ENDPATH**/ ?>