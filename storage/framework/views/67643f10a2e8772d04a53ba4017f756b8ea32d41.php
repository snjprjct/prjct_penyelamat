...
<?php $__env->startSection('judul'); ?> Data siswa <?php $__env->stopSection(); ?>
...
<table class="table table-striped">
  ...
  <tbody> <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <tr>
      <th scope="row"><?php echo e($loop->iteration); ?>   - <?php echo e($posta->id); ?></th>
      <td>
        <a href="/siswa/<?php echo e($posta->slug); ?>"><?php echo e($posta->nis); ?></a>
      </td>
      <td><?php echo e($posta->nama_siswa); ?></td>
      <td><?php echo e($posta->kelas->nama_kelas); ?></td>
      <td>
        <a href="/siswa/<?php echo e($posta->slug); ?>/edit"  role="button" class="btn btn-warning">Edit</a>
<form action="/siswa/<?php echo e($posta->slug); ?>" class="d-inline" method="post">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\spp\resources\views/siswa/index.blade.php ENDPATH**/ ?>