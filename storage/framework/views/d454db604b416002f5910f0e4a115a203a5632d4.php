...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr >
                     ...
                     <tr>
                        ...
                        <td><div class="value"><?php echo e($p->slug); ?>/<?php echo e($p->id); ?></div></td>
                    </tr>
                    <tr>
                        <td><div class="lead">Telah terima dari: </div></td>
                        <td><div class="value"><?php echo e($p->siswa->nama_siswa); ?></div></td>
                    </tr>
                    <tr>
                        <td><div class="lead">Untuk Pembayaran:</div></td>
                        <td><div class="value">SPP Bulan <?php echo e($p->bulan); ?> <?php echo e($p->tahun); ?></div></td>
                    </tr>
                    <tr>
                        <td><div class="lead">Tanggal:</div></td>
                        <td><div class="value"><?php echo e(date($p->updated_at)); ?></div></td>
                    </tr>
                    <tr>
                        <td><div class="lead">Rupiah:</div></td>
                        <td><div class="value-big"><?php echo e(($total = $p->total)); ?></div></td>
                    </tr>
                    <tr>
                        <td><div class="lead">Uang Sejumlah:</div></td>
                        <td><div class="value"> <?php echo e(terbilang($total)); ?> </div></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
...
</html><?php /**PATH D:\laravel\coba1\spp\resources\views/pembayaran/kwitansi.blade.php ENDPATH**/ ?>