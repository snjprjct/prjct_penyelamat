            ...
            <div class="ticket-card">
              ...
              <div class="body">
                ...
                <div class="price">
                  ...
                  <div class="value">
                    <strong>Rp. <?php echo 
            number_format($paket->harga,0,',','.');?></strong>
                  </div>
                </div>
              ...
              <div class="footer">
                ...
                <?php else: ?>:
                <button class="btn toggle-tickets" onclick="location.href='/create?idp=<?php echo e($paket->id); ?>'" ><strong>Cek Sekarang</strong></button>
                <?php endif; ?>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Zahlan Nugraha\Downloads\photography\photography\resources\views/paket.blade.php ENDPATH**/ ?>