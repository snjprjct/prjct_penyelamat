        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <input name="nama_paket" value="<?php echo e(old('nama_paket')); ?>" placeholder="Nama Paket" id="nama_paket" class="form-control" >
                ...
                <div class="form-group">
                    ...
                    <input name="harga" value="<?php echo e(old('harga')); ?>" id="harga" placeholder="Harga" class="form-control">
                ...
                <input name="jumlah_jam" value="<?php echo e(old('jumlah_jam')); ?>" id="jumlah_jam" placeholder="Jumlah Jumlah" class="form-control">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Zahlan Nugraha\Downloads\photography\photography\resources\views/dashboard/paket/create.blade.php ENDPATH**/ ?>