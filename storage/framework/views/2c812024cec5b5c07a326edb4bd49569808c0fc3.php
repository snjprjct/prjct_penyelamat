...
<div class="container">
    ...
    <br>
    <br>
    <form method="post" enctype="multipart/form-data" action="/team/<?php echo e($team->id); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-md-5">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('nama',$team->nama)); ?>" name="nama" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline"> 
                      <input class="form-check-input" type="radio" name="jk" id="jk1" value="Laki-Laki" <?php echo e($team->jk == 'Laki-Laki' ? 'checked' : ''); ?>>
                      <label class="form-check-label" for="jk1">Laki-Laki</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="jk" id="jk2" value="Perempuan" <?php echo e($team->jk == 'Perempuan' ? 'checked' : ''); ?> >
                ...
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('nama',$team->telepon)); ?>" name="telepon" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" required  value="<?php echo e(old('alamat',$team->alamat)); ?>" name="alamat" class="form-control" id="alamat" placeholder="Alamat team"><?php echo e(old('alamat',$team->alamat)); ?></textarea>
                   </div>
            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('tempat_lahir',$team->tempat_lahir)); ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('tanggal_lahir',$team->tanggal_lahir)); ?>" name="tanggal_lahir"
                ...
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('posisi',$team->posisi)); ?>" name="posisi"
                ...
                <div class="form-group">
                   ...
                   <input type="hidden" name="oldImage" value="<?php echo e($team->foto); ?>">
                    <?php if($team->foto): ?>
                    <img src="<?php echo e(asset('storage/' . $team->foto)); ?>" class="img-preview img-fluid">
                   <?php echo e($team->foto); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 7\SKRIPSI\PEMROGRAMAN\photography (1)\photography\resources\views/dashboard/team/edit.blade.php ENDPATH**/ ?>