    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/pembayaran/<?php echo e($posta['slug']); ?>"><?php echo e($posta->periode->bulan); ?>

                        <?php echo e($posta->periode->tahun); ?></a></td>
                <td><?php echo e($posta->siswa->nama_siswa); ?></td>
                <td>Rp. <?php echo 
            number_format($posta->total,0,',','.');?></td>
                <td><?php echo e($stat = $posta->status); ?></td>
                <td>
                    <?php if($stat=="Menunggu Konfirmasi"): ?>
                    <a href="/pembayaran/<?php echo e($posta->slug); ?>/edit" role="button" class="btn btn-warning">Konfirmasi</a>
                    <?php endif; ?>
                    <form action="/pembayaran/<?php echo e($posta->slug); ?>" class="d-inline" method="post">
    ...
    <div class="col-md-8">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><a href="/pembayaran/cetak_pdf"><?php echo e($loop->iteration); ?></a></th>
                    <td><a href="/pembayaran/<?php echo e($posta['slug']); ?>">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/pembayaran/create?bulan=<?php echo e($postar->bulan); ?>" role="button" class="btn btn-warning">Bayar</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\spp\resources\views/pembayaran/index.blade.php ENDPATH**/ ?>