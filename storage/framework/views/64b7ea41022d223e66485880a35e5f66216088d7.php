        ...
        <tbody>
            ...
            number_format($posta->harga,0,',','.');?></td>
                ...
                <td>
                    ...
                    <button onclick="location.href='/paket/<?php echo e($posta->id); ?>/edit'" role="button" class="new button">
                        <img src="https://i.ibb.co/FW9tsHK/attachment.png"></button>                    
                   <form action="/paket/<?php echo e($posta->id); ?>" class="d-inline" method="post">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 7\SKRIPSI\PEMROGRAMAN\photography (1)\photography\resources\views/dashboard/paket/index.blade.php ENDPATH**/ ?>