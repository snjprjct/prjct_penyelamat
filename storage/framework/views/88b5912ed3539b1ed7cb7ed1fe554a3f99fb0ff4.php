                    ...
                    <div class="col-md-12 col-md-pull-7">
                        <div class="booking-form">
                            <form method="post" action="/booking/cek">
                                ...
                                <?php else: ?>
                                <input class="form-control" name="paket" value="<?php echo e(request()->idp); ?>" type="text"
                                >
                                <?php endif; ?>
                        ...
                        <form method="post" action="/booking" enctype="multipart/form-data">
                            ...
                            <div class="container card-body" style="padding:30px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Nama iPaket yang diPilih</label>
                                        <Br>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input type="text" name="customer_id" hidden value="<?php echo e(auth()->user()->customer->id); ?>"
                                    class="browser-default custom-select mb-4" id="select"> <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 7\SKRIPSI\PEMROGRAMAN\photography (1)\photography\resources\views/create.blade.php ENDPATH**/ ?>