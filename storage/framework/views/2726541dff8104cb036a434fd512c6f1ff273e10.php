            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo e(old('jumlah_jam',$paket->jumlah_jam)); ?>" name="jumlah_jam" class="form-control"
                        id="jumlah_jam" placeholder="Harga Paket">
                </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\photography\resources\views/dashboard/paket/edit.blade.php ENDPATH**/ ?>