    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($posta->paket_id); ?></td>
                <td>Rp. <?php echo 
            number_format($posta->total,0,',','.');?></td> 
                <td>
                     
                    <a href="/booking/<?php echo e($posta->slug); ?>/edit" role="button" class="btn btn-warning">Konfirmasi</a>
                   
                    <form action="/booking/<?php echo e($posta->slug); ?>" class="d-inline" method="post">
    ...
    <div class="col-md-8">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><a href="/booking/cetak_pdf"><?php echo e($loop->iteration); ?></a></th>
                    <td><a href="/booking/<?php echo e($posta['slug']); ?>">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/booking/create?bulan=<?php echo e($postar->bulan); ?>" role="button" class="btn btn-warning">Bayar</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\photography\resources\views/booking/index.blade.php ENDPATH**/ ?>