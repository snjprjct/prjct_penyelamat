        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <textarea type="textarea" required value="<?php echo e(old('kegiatan')); ?>" name="kegiatan"
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Zahlan Nugraha\Downloads\photography\photography\resources\views/dashboard/galery/create.blade.php ENDPATH**/ ?>