    ...
    <table class="table table-striped">
        ...
        <tbody style="overflow:auto;">
            ...
            <tr>
                ...
                <td>
                    <a href="/user/<?php echo e($posta->id); ?>/edit" role="button" class="btn btn-warning">Edit</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\photography\resources\views/user/index.blade.php ENDPATH**/ ?>