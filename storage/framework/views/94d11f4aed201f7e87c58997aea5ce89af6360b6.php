        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/galery/<?php echo e($posta->id); ?>/edit" role="button" class="btn btn-warning">Edit</a>
    ...
    <div class="col-md-8">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><a href="/galery/cetak_pdf"><?php echo e($loop->iteration); ?></a></th>
                    <td><a href="/galery/<?php echo e($posta['slug']); ?>">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/galery/create?bulan=<?php echo e($postar->bulan); ?>" role="button" class="btn btn-warning">Bayar</a>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\coba1\photography\resources\views/dashboard/galery/index.blade.php ENDPATH**/ ?>