    ...
    <div class="left">
      ...
      <div class="navigation">
        <div class="wrapper2">
          ...
          <div class="folder-icons" onclick="location.href='{{ route('user.index') }}';">
        <div class="icon1">
          ...
          <div class="folder-icons" onclick="location.href='{{ route('customer.index') }}';">
            <div class="icon1">
              <img src="https://i.ibb.co/qdgf3TJ/envelope.png" />
            </div>
          ...
          <div class="folder-icons"  onclick="location.href='{{ route('team.index') }}';">
            <div class="icon1">
          ...
          <div class="folder-icons"  onclick="location.href='{{ route('galery.index') }}';">
            <div class="icon1">
              <img src="https://i.ibb.co/6ZH9kK3/star.png" />
            </div>
          ...
          <div class="folder-icons"  onclick="location.href='{{ route('paket.index') }}';"> 
            <div class="icon1">
