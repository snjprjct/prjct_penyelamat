    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/team/{{ $posta->id}}">{{ $posta->nama }}</a></td>
                <td>{{ $posta->posisi }}</td>

                <td><img src="{{ asset('storage/' . $posta->foto) }}" style="height:20px" alt="{{ $posta->nama }}" class="img-fluid mt-3"></td>
                <td>
                   
                <button onclick="location.href='/team/{{$posta->id}}/edit'" role="button" class="new button">
                        <img src="https://i.ibb.co/FW9tsHK/attachment.png"></button>                    
                   <form action="/team/{{ $posta->id }}" class="d-inline" method="post">
                        @method('delete')
                        @csrf
    ...
    <div class="col-md-8">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><a href="/team/cetak_pdf">{{ $loop->iteration }}</a></th>
                    <td><a href="/team/{{ $posta['slug']}}">
                            {{ $posta->periode->bulan }}
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/team/create?bulan={{ $postar->bulan }}" role="button" class="btn btn-warning">Bayar</a>
