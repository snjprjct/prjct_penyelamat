        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/rekening/{{$posta->id}}/edit" role="button" class="new button">
...
<div class="cards">
                ...
                <div class="card">
                    <div class="card__image-holder">
                      <img class="card__image" src="{{ asset('storage/' . $posta->foto_bank) }}" alt="wave" />
                    </div>
                    <div class="card-title">
                      ...
                      <h2>
                        {{$posta->atas_nama}}
                        <small><br>{{$posta->rekening}}</small><br>
                      </h2>
                      <a href="#" >
                        <input type="text" value="{{ $posta->rekening}}" hidden id="copyText" >
